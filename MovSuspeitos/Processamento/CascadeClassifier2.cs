...
namespace Emgu.CV
{
   ...
   /// </summary>
   public class CascadeClassifier2 : UnmanagedObject
   {
      static CascadeClassifier2()
      {
      ...
      public CascadeClassifier2(String fileName)
      {
#if !NETFX_CORE
...
#else
            throw new FileNotFoundException("notfound", file.FullName);
#endif
#endif
...
#else
            throw new NullReferenceException(String.Format("fail", file.FullName));
#endif
         }
      }
